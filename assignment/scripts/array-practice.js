...
let favoriteFoods = [`French Fries`, `Sushi`,`Red Cow Burgers`]
...
console.log(`Number of foods`, numberOfAnimals);
...
console.log(`Removed the last color`, removedColor);
...
console.log(gems);
// Got some help from google to figure out 5B
